...
export default function DashboardDetailPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white font-cabinet">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-400 font-bold text-sm tracking-widest uppercase italic">Loading analysis...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white font-cabinet p-6">
        <div className="flex flex-col items-center text-center max-w-md">
          ...
          <h2 className="text-2xl font-black text-gray-900 tracking-tight mb-2">Analysis not found or session expired</h2>
          <p className="text-gray-500 font-medium mb-8">The requested audit record is unavailable or you do not have permission to view it.</p>
          <button 
  ...
  const proofs = item.proof?.split("\n").filter(p => p.trim()) || ["No proof captured yet."];
    ...
    <div className="min-h-screen bg-white font-cabinet text-gray-900 selection:bg-red-50 selection:text-vouch-red">
      ...
      <nav className="sticky top-0 z-[100] bg-white/95 backdrop-blur-md border-b border-gray-100 h-[58px] px-8 flex items-center gap-4">
        <div className="flex items-center gap-2.5">
          ...
          <span className="bg-red-50 border border-red-100 text-vouch-red text-[9px] font-extrabold tracking-widest uppercase rounded-full px-2 py-0.5">Detail</span>
        </div>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-gray-400 text-[10px] font-bold tracking-widest uppercase">Private Analysis</span>
        </div>
        ...
        <Link 
          href="/dashboard"
          className="flex items-center gap-2 bg-transparent border border-gray-200 rounded-lg px-4 py-1.5 text-gray-600 text-sm font-bold hover:bg-gray-50 transition-all"
        >
        ...
        <aside className="hidden lg:flex w-72 border-r border-gray-100 p-8 flex-col gap-8 bg-gray-50/50 shrink-0">
          <section>
            ...
            <div className="flex flex-col gap-4">
              {[
                { label: "Analysis ID", val: item.id.slice(0, 12) + "..." },
                { label: "Engine", val: "VOUCH_V1" },
                { label: "Confidence", val: biasScore > 0 ? "98.4%" : "..." },
                { label: "Created", val: new Date(item.createdAt).toLocaleDateString([], { month: 'short', day: 'numeric', year: 'numeric' }) }
              ].map(meta => (
                <div key={meta.label}>
          ...
          <section>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 flex items-center gap-3">
              <ShieldCheck size={18} className="text-vouch-red shrink-0" />
              <div className="text-[11px] font-black tracking-tighter text-gray-900">PRIVATE_ENCRYPTED</div>
            </div>
          </section>
          ...
          >
            ...
            <header className="mb-16 grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-12 items-start">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-vouch-red text-xs font-black tracking-widest uppercase">Analysis Detail</span>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-12">
              ...
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-black tracking-tight">AI Response</h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { label: "Source Trust", val: "VERIFIED", icon: <ShieldCheck size={16} /> },
              ...
              <section>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-black tracking-tight">Proof Log</h2>
                </div>
                ...
                <div className="bg-gray-900 rounded-[24px] p-8 text-center text-white relative overflow-hidden">
                  ...
                  <h3 className="text-lg font-black mb-2 tracking-tight">Confidential Report</h3>
                  <p className="text-white/50 text-xs font-medium leading-relaxed">This analysis is private to your account and encrypted.</p>
                </div>
              </section>
            </div>
            ...
            <footer className="mt-20 pt-8 border-t border-gray-100 flex flex-wrap justify-between items-center gap-4">
              <div className="text-[10px] font-black uppercase tracking-widest text-gray-300">
                © 2025 VOUCH_INTELLIGENCE_ENGINE // PRIVATE_AUDIT
              </div>
